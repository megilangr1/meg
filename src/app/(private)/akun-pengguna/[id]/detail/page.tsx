    ...
    <div className="flex flex-col gap-4">
      <Card className="gap-0">
        <CardHeader className="border-b">
          ...
          <CardDescription>Rincian detail akun pengguna</CardDescription>
          ...
          <CardAction className="flex flex-row gap-2">
            ...
            <Button
              variant={"outline"}
              size={"sm"}
              render={<Link href={`/akun-pengguna/${"123"}/edit`} />}
              nativeButton={false}
            >
              <Edit />

              <span className="hidden sm:block">Edit Data</span>
            </Button>
          </CardAction>
        </CardHeader>
        <CardContent>Detail Pengguna - {id}</CardContent>
        <CardFooter>
